...
class rtmSalesExport implements FromCollection,ShouldAutoSize,WithStyles
{
    public $sales;
    public $start_date;
    public $end_date;
    ...
    */
    public function collection()
    {
        ...
        $headers = [
            ["RTM Sales Report: ".$text." - Ranked By ".(($this->sort_by == 'total_quantity')?'Total Order':"Total Sales")],
