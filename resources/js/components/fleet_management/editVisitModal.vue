...
export default {
    ...
    mounted(){
        this.formData.route_id = this.visit.id
        this.formData.user_id = this.visit.user_id
        this.formData.commission = this.visit.commission
        this.getRoutes()
