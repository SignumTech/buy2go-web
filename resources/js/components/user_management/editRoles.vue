<template>
    <div class="row p-4 overflow-auto" style="height:80vh">
        ...
        <div v-if="formData.deletable" class="col-md-6 mb-4">
        ...
        <div class="col-md-12 mt-3">
            <button @click="updatePermission()" class="btn btn-primary btn-sm px-3 rounded-1 float-end"><span class="fa fa-edit"></span> Update Role</button>
...
export default {
    props:['role'],
    mounted(){
        this.formData.role = this.role.role
        this.formData.id = this.role.id
        this.formData.deletable = this.role.deletable
        this.formData.permissions = JSON.parse(this.role.permissions)
    },
    data(){
        return{
            valErrors:{},
    ...
    methods:{
        async updatePermission(){
            await axios.post('/updateRolePermission', this.formData)
            .then( response => {
                this.$notify({
                        group: 'foo',
                        type: 'success',
